 ...
 */
export function isClamped(curve is BSplineCurve) returns boolean
{
    return isClamped(curve, KNOT_TOLERANCE);
}
 ...
 */
export function hasValidKnotOrder(curve is BSplineCurve) returns boolean
{
    var knots = curve.knots;
