...
def main() -> int:
    ...
    get_parser.add_argument("--folder", help="Only pull files currently located under this local subdirectory (e.g. 'tools')")
    ...
    push_new_parser.add_argument("--folder", help="Only push files under this local subdirectory (e.g. 'tools')")
