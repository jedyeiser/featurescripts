 ...
 *   prismaticDeflection_mm    : Deflection (mm) at MRS under 30kg load, prismatic beam
 *   estimatedStiffness_lbin   : Load (lbs) to deflect 25.4mm at MRS, variable EI
 *   estimatedDeflection_mm    : Deflection (mm) at MRS under 30kg load, variable EI
 *
 * EI Data:
 * --------
 ...
 * @param xFCP {ValueWithUnits} : X position of front contact point
 * @param xACP {ValueWithUnits} : X position of aft contact point
 * @returns {map} : {
 *     EI_bar: ValueWithUnits (N*m^2),
 *     L: ValueWithUnits (m),
 *     xMRS: ValueWithUnits (m),
 *     prismaticStiffness_lbin: number,
 *     prismaticDeflection_mm: number,
 *     estimatedStiffness_lbin: number,
 *     estimatedDeflection_mm: number
 * }
 */
                                      ...
                                      xACP is ValueWithUnits) returns map
{
    ...
    var prismaticDeflection_mm = prismatic_delta / millimeter;
    ...
    var estimatedDeflection_mm = estimated_delta / millimeter;
    ...
    return {
        ...
        "prismaticDeflection_mm" : prismaticDeflection_mm,
        "estimatedStiffness_lbin" : estimatedStiffness_lbin,
        "estimatedDeflection_mm" : estimatedDeflection_mm
    };
}
