 ...
 *
 *  Great candidates:
 *    - evDistance → @evDistance (returns unitless)
 *    - evApproximateBSplineCurve → @evApproximateBSplineCurve
 *    - evApproximateBSplineSurface → @evApproximateBSplineSurface
 *    - evaluateSpline → can likely remain as-is since it's not a context call
 *
